...
export default class EditExercise extends Component {
  ...
  componentDidMount() {
    axios.get('http://localhost:5000/exercises/' + this.props.match.params.id) // this is to grab the specific exercise
    .then(response => {
      this.setState({
  ...
  onSubmit(e) {
    ...
    axios
      .post("http://localhost:5000/exercises/update/" + this.props.match.params.id, exercise) // remember u need another / in the url if including id
